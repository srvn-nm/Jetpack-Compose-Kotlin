...
android {
    namespace = "com.example.sarvinBusinessCard"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.sarvinBusinessCard"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
//    implementation ("androidx.compose.material3:material3-icons-extended:1.12.0")
